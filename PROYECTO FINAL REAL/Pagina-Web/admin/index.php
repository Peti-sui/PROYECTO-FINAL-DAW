...
<body style="background-color: #440203" class="admin-panel">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span class="text-white" style="font-size: 20px;">Bienvenido, <?php echo $_SESSION['admin_usuario']; ?></span>
    </div>

    <div class="card bg-dark text-white p-3 mb-4">
        <form method="GET" class="row g-3">
            <div class="col-md-8">
                <input type="text" name="buscar" class="form-control" placeholder="Buscar por nombre, descripción o categoría..." value="<?php echo isset($_GET['buscar']) ? htmlspecialchars($_GET['buscar']) : ''; ?>">
            </div>
            <div class="buscar col-md-2">
                <button type="submit" class="btn btn-primary w-100" style="background-color:#D4AF37; color: #1A1A1A;border:none;">Buscar</button>
            </div>
            <div class=" limpiar col-md-2">
                <a href="index.php" class="btn w-100" style="background-color:#E5E5E5; color: #440203; border:none; ">Limpiar</a>
            </div>
        </form>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="producto-editar.php?id=<?php echo $prod['id']; ?>" class="btn btn-primary text-white btn-sm" style="margin-bottom:10px;">Editar</a>
                        <a href="producto-eliminar.php?id=<?php echo $prod['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar este producto?')" style="margin-bottom:10px;">Eliminar</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
        ...
        <?php if(isset($_GET['buscar']) && !empty($_GET['buscar'])): ?>
            <p class="text-white mt-3">Resultados para: <strong><?php echo htmlspecialchars($_GET['buscar']); ?></strong></p>
        <?php endif; ?>
    </div>
</main>
